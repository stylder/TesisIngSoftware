...
\documentclass[a4paper,12pt,leqno,oneside,openany]{memoir} %add 'draft' to turn draft option on (see below)
...
\ifpdf
\pdfinfo{
   /Author (Joyce Selene Anaid Lozano Aguilar, Dra. Alejandra Garc\'ia Hern\'andez, M.C.C Alejandro Mauricio Gonz\'alez)
   /Title (Tesis Licenciatura)
...
%Needed to encode non-english characters 
									%directly for mac
...
\newtheorem{dfn}{Definici\'on}[chapter]
\theoremstyle{plain}
\newtheorem{lema}{Lema}[chapter]
\theoremstyle{plain}
\newtheorem{cor}{Corollary}[chapter]
\theoremstyle{plain}
\newtheorem{resu}{Resultado}[chapter]
%
...
%
\listoftables
\addtocontents{lot}{\par\nobreak\textbf{{\scshape Tabla} \hfill P\'agina}\par\nobreak}
\clearemptydoublepage
%
\listoffigures
\addtocontents{lof}{\par\nobreak\textbf{{\scshape Figura} \hfill P\'agina}\par\nobreak}
\clearemptydoublepage
%
%
